              ...
              {success ? (
                ...
                <form onSubmit={handleSignUp} className="space-y-4">
                  ...
                  <label className="flex items-start gap-2 text-xs text-white/60">
                    ...
                    <span>
                      I agree to the{" "}
                      <Link href="/terms" className="text-[#00BFA5] hover:underline">
                        Terms of Service
                      </Link>{" "}
                      and{" "}
                      <Link href="/privacy" className="text-[#00BFA5] hover:underline">
                        Privacy Policy
                      </Link>
                    </span>
                  </label>
              ...
              {!success && (
                <>
                  ...
                  <p className="text-center text-sm text-white/60 mt-6">
                    ...
                    <Link href="/auth/signin" className="text-[#00BFA5] hover:underline">
                      Sign in
                    </Link>
                  </p>
                </>
